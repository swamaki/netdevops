...
for devices in device_list:
    ...
    if software_ver == 'IOS XE':
        ...
        for show_command_iosxe in commands_list_iosxe:
            ...
            commands_output_iosxe = net_connect.send_command(show_command_iosxe, delay_factor=2)
            #time.sleep(5)
            output_filename = "%s_%.2i%.2i%i_%.2i%.2i%.2i" % (device_hostname,time_now.year,time_now.month,time_now.day,time_now.hour,time_now.minute,time_now.second)
    ...
    # Run 'NX-OS' relevant commands on (nexus)
        ...
        for show_command_nexus in commands_list_nexus:
            ...
            commands_output_nexus = net_connect.send_command(show_command_nexus, delay_factor=2)
            #time.sleep(5)
            output_filename = "%s_%.2i%.2i%i_%.2i%.2i%.2i" % (device_hostname,time_now.year,time_now.month,time_now.day,time_now.hour,time_now.minute,time_now.second)
            output_file = open(output_filename, "a")
    ...
    # Run 'vios_l2-ADVENTERPRISEK9-M' relevant commands (switches)
        ...
        for show_command_switch in commands_list_switch:
            ...
            commands_output_switch = net_connect.send_command(show_command_switch, delay_factor=2)
            #time.sleep(5)
            output_filename = "%s_%.2i%.2i%i_%.2i%.2i%.2i" % (device_hostname,time_now.year,time_now.month,time_now.day,time_now.hour,time_now.minute,time_now.second)
            output_file = open(output_filename, "a")
    ...
    # Run 'VIOS-ADVENTERPRISEK9-M' relevant commands (routers)
        ...
        for show_command_router in commands_list_router:
            ...
            commands_output_router = net_connect.send_command(show_command_router, delay_factor=2)
            #time.sleep(5)
            output_filename = "%s_%.2i%.2i%i_%.2i%.2i%.2i" % (device_hostname,time_now.year,time_now.month,time_now.day,time_now.hour,time_now.minute,time_now.second)
            output_file = open(output_filename, "a")
