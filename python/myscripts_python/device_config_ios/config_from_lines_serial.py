...
def configure_device(ip_address):
    ...
    setting config file=yml and using load.yml results in config not loaded properly
    ...
    try: 
        with ConnectHandler(**device_params) as device_conn:
            ...
            commands_output.append(device_conn.send_config_set(config_commands, delay_factor=2))
